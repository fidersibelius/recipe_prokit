...
import 'package:bitsoftickets/screens/RCCommentScreen.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            16.height,
            Image.asset(widget.element.foodImg.validate(),
                    height: 170, width: context.width(), fit: BoxFit.cover)
                .cornerRadiusWithClipRRect(30),
            16.height,
            Text(
              'simply dummy text of the printing and typesetting industry.has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.',
              style: secondaryTextStyle(color: rcSecondaryTextColor),
            ),
            30.height,
            Row(
